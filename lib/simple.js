...
const { MessageType, WAMessageProto, WAMetric } = require('@adiwajshing/baileys')
...
`.trim()
  ...
  async toMSG(buffer, type) {
   let data = await this.prepareMessage('0@s.whatsapp.net', buffer, type, { thumbnail: fs.readFileSync('./src/error.png') })
